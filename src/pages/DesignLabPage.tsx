...
export const DesignLabPage: React.FC = () => {
  ...
  return (
    <div className="space-y-8 pb-16">
      {/* Vibrant Hero Header */}
      <div className="relative overflow-hidden rounded-3xl p-8 border border-indigo-200/50 bg-gradient-to-r from-fuchsia-600 via-purple-600 to-indigo-600 shadow-xl text-white">
        ...
        {/* Tab Navigation */}
        <div className="flex items-center gap-2 mt-8 border-b border-slate-200 pb-2 overflow-x-auto">
          <button
              ...
              {gradients.map((grad, i) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="font-heading font-bold text-sm text-slate-900">{grad.name}</h4>
                      <p className="text-[11px] font-mono text-slate-500">Tailwind: bg-gradient-to-r</p>
                    </div>
                  </div>
                  <button
                    onClick={(e) => {
          ...
          <div className="p-6 rounded-3xl bg-slate-900/80 border border-slate-800 space-y-4 shadow-xl">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="text-xs font-mono text-slate-600 hover:text-slate-900 hover:bg-slate-100 flex items-center gap-1"
              >
      ...
      {activeTab === 'typography' && (
        <div className="p-8 rounded-3xl bg-white border border-slate-200 shadow-sm space-y-6 shadow-xl">
          <div>
