          ...
          <div className="flex items-center gap-3">
            {onOpenActionModal && (
              <button
                ...
                className="px-4 py-2.5 rounded-xl bg-white hover:bg-slate-50 text-slate-800 text-xs font-mono border border-slate-200 flex items-center gap-2 shadow-sm transition-all active:scale-95"
              >
          ...
          <div className="p-6 bg-surface-subtle border border-border-subtle rounded-3xl space-y-4 shadow-xl">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-xl p-3 text-xs text-slate-900 font-mono focus:outline-none focus:border-indigo-600 focus:bg-white transition-colors resize-none leading-relaxed"
              />
            </div>
              ...
              <div className="flex flex-wrap gap-1.5">
                {currentModeConfig.presets.map((pr, idx) => (
                  <button
                    ...
                    className="text-[11px] font-mono px-2.5 py-1 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-200 transition-colors text-left truncate max-w-full"
                  >
                    + {pr}
                  </button>
                ))}
          ...
          <div className="p-6 bg-surface-subtle border border-border-subtle rounded-3xl flex-1 flex flex-col space-y-4 shadow-xl">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 pb-3 border-b border-border-subtle">
              ...
              <div className="flex items-center gap-2">
                {activeMode === 'ui_component' && (
                  <div className="flex bg-slate-100 p-0.5 rounded-lg border border-slate-200 text-[11px] font-mono">
                    <button
                ...
                <button
                  onClick={handleCopy}
                  className="p-1.5 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-200 text-xs flex items-center gap-1 transition-all"
            ...
            {viewMode === 'preview' && activeMode === 'ui_component' ? (
              <div className="flex-1 min-h-[380px] p-6 bg-canvas border border-border-subtle rounded-2xl flex items-center justify-center">
                <div className="w-full max-w-md p-6 rounded-2xl bg-white border border-indigo-200 shadow-xl relative overflow-hidden group">
